...
/**
 * SelectOperatorNode is a class to represent the select operator in the logical
 * query plan.
 */
public class SelectOperatorNode extends OperatorNode {
   ...
   * 
   * @param whereExpression the expected where expression of the select operator
   *                        node
   */
