...
public class P1UnitTests {
    ...
    static void setupBeforeAllTests() throws IOException, JSQLParserException {
        try {
            ...
            String path = Paths.get(Objects.requireNonNull(classLoader.getResource("samples/input"))
                    .toURI()).toString();
            DBCatalog.getInstance().setDataDirectory(path + "/db");
            String queriesFile = Paths.get(Objects.requireNonNull(classLoader.getResource("samples/input/queries.sql"))
                    .toURI()).toString();
    ...
    public void testQuery1() throws ExecutionControl.NotImplementedException {
        ...
        Tuple[] expectedTuples = new Tuple[] { new Tuple(new ArrayList<>(List.of(1, 200, 50))),
    ...
    public void testQuery2() throws ExecutionControl.NotImplementedException {
        ...
        Tuple[] expectedTuples = new Tuple[] { new Tuple(new ArrayList<>(List.of(1))),
                new Tuple(new ArrayList<>(List.of(2))), new Tuple(new ArrayList<>(List.of(3))),
                new Tuple(new ArrayList<>(List.of(4))), new Tuple(new ArrayList<>(List.of(5))),
    ...
    public void testQuery4() throws ExecutionControl.NotImplementedException {
        ...
        Tuple[] expectedTuples = new Tuple[] { new Tuple(new ArrayList<>(Arrays.asList(1, 200, 50))),
    ...
    public void testQuery6() throws ExecutionControl.NotImplementedException {
        ...
        for (int i = 0; i < expectedSize; i++) {
            Tuple actualTuple = tuples.get(i);
            Assertions.assertEquals(expectedTuples[i], actualTuple,
                    "Unexpected tuple at index " + i);
        }
    }
    ...
    public void testQuery7() throws ExecutionControl.NotImplementedException {
        ...
        Tuple[] expectedTuples = new Tuple[] { new Tuple(new ArrayList<>(Arrays.asList(1))),
    ...
    public void testQuery8() throws ExecutionControl.NotImplementedException {
        ...
        Tuple[] expectedTuples = new Tuple[] { new Tuple(new ArrayList<>(Arrays.asList(3, 100, 105))),
